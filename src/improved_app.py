"""
Improved Flask web application for football analytics dashboard without Kafka.
This version is more resilient to API rate limits and shows upcoming matches.
"""
import json
import threading
import time
...
class FootballDataAPI:
    ...
    def get_matches(self, date_from=None, date_to=None, status=None):
        ...
        # Just use Premier League to avoid rate limiting
